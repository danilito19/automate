...
def get_weather_forecast():
    ...
    url = 'http://api.openweathermap.org/data/2.5/weather?q=Chicago,il&units=imperial&appid=f641b59e03463c808393605f493b1f93'
    ...
    forecast = 'The Chicago forecast for today is '
